...
:: Android packaging
set AND_CERT_NAME="Sanguo"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Sanguo.p12
...
set IOS_PROVISION=cert\Sanguo.mobileprovision
...
set APP_ID=air.com.ado.main.Sanguo

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Sanguo
